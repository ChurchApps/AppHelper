...
import { ApiHelper, AppearanceInterface } from "../../helpers";
  ...
  return (
    <>
      <Elements stripe={stripePromise}>
        <NonAuthDonationInner churchId={props.churchId} mainContainerCssProps={mainContainerCssProps} showHeader={showHeader} recaptchaSiteKey={props.recaptchaSiteKey} appearance={props?.appearance} />
      </Elements>
    </>
  );
}
